...
export default function SignIn() {
  ...
  const secondaryButtonClass = cn(
    ...
    isDark
      ...
      : "text-[#1E2654]/65 hover:text-[#0C1024]"
  );
        ...
        >
          ...
          <div className="relative z-10 space-y-8 px-8 py-10 sm:px-10">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className={cn("text-lg font-semibold", strongText)}>Log in to your hive</p>
                </div>
              </div>
              <button
                type="button"
            ...
            <div className="space-y-2 text-center">
              <p className={cn("text-sm", subduedText)}>Welcome back! Please enter your details.</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className={cn("flex items-center justify-between text-sm", subduedText)}>
                <label className="inline-flex items-center gap-3">
                  <input
                    type="checkbox"
                    className={cn(
                      "h-4 w-4 rounded accent-[#8C6BFF]",
                      isDark ? "border-white/25 bg-black/60" : "border-[#C7D1FF] bg-white"
                    )}
                  />
                ...
                <Link
                  href="#"
                  className={cn("text-sm font-medium underline-offset-4 hover:underline", isDark ? "text-white/70" : "text-[#4250A0]")}
                >
                  Forgot password
                </Link>
              </div>
