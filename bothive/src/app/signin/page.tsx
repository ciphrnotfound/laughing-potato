        ...
        >
          <div className="space-y-2">
            ...
            <p className="text-sm sm:text-base text-white/60">
              Sign in to your Bothive account to continue
            </p>
          </div>
          ...
          <div className="space-y-5">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <Link href="#" className="group relative text-sm text-purple-400 hover:text-purple-300 transition-colors">
                  Forgot password?
          ...
          <div className="space-y-4">
            ...
            <p className="text-center text-sm sm:text-base">
              ...
              <Link href="/signup" className="group relative font-medium text-purple-400 hover:text-purple-300 transition-colors">
                Create one
                <span className="absolute -bottom-0.5 left-0 h-px w-0 bg-linear-to-r from-purple-400/40 via-purple-400 to-purple-400/40 transition-all group-hover:w-full" />
              </Link>
            </p>
